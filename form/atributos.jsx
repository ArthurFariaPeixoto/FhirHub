        ...
        <React.Fragment>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                    <TextFieldElement id="name" name="name" label="Name" placeholder="ExampleValueSet" helperText={showHelperText ? "Nome para este ValueSet (compatível com computador)" : null} fullWidth onChange={(e) => setName(e.target.value)} />
                </Grid>
                ...
                <Grid item md={6} xs={12}>
                    <TextFieldElement id="title" name="title" label="Title" placeholder="Example ValueSet" helperText={showHelperText ? "Nome para este ValueSet (amigável para humanos)" : null} fullWidth />
                </Grid>
                ...
                <Grid item md={6} xs={12}>
                    <TextFieldElement id="publisher" name="publisher" label="Publisher" placeholder="Example Healthcare Organization" helperText={showHelperText ? "Nome do editor (organização ou indivíduo)" : null} fullWidth />
                </Grid>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item md={12} xs={12}>
                    <TextFieldElement id="purpose" name="purpose" label="Purpose" placeholder="This ValueSet is created for demonstrating FHIR capabilities." helperText={showHelperText ? "Por que esse ValueSet é definido" : null} fullWidth />
                </Grid>
                <Grid item md={12} xs={12}>
                ...
                <Grid item md={12} xs={12}>
                    <FormControlLabel control={<Switch color="primary" onChange={handleSwitchChange} />} label="Descrições dos campos acima" />
                </Grid>
            </Grid>
        </React.Fragment>
    );
